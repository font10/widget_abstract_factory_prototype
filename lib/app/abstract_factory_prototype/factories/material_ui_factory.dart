...
class MaterialUIFactory implements UIFactory {
  ...
  final IAppButton _buttonPrototype = const MaterialAppButton(
    text: 'prototype',
  );
  final IAppTextField _textFieldPrototype = const MaterialAppTextField(
    placeholder: 'prototype',
  );
  final IAppDialog _dialogPrototype = const MaterialAppDialog(
