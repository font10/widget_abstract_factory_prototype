...
void main() {
  group('AppTextField Tests (Unitarios)', () {
    ...
    test('MaterialAppTextField debe gestionar placeholder y controller correctamente', () {
      ...
      expect(clon.controller, myController); // ¡La misma instancia! Vital para no perder el texto
    });
